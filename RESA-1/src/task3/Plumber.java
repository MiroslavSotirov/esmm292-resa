...
public class Plumber {
    public static void main(String argv[]) {
        ...
        SinkFilter sinkFilter = new SinkFilter(new int[]{0, 4, 2, 3}, "OutputC.dat");
        SinkFilter wildpointsSinkFilter = new SinkFilter(new int[]{0, 3}, "WildPoints.dat");
        SinkFilter less10kSinkFilter = new SinkFilter(new int[]{0, 3}, "LessThan10K.dat");
        ...
        wildpointsFilter.Connect(lessThan10KFilter, 0, 1);
        less10kSinkFilter.Connect(lessThan10KFilter, 0, 0);
